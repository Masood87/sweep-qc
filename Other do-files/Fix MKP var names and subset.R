...
# import the data
filename <- "~/Dropbox/SWEEP shared/Baseline QC Reports/Data/SWEEP_MPK_Final_2018_09_12_01_31_37_573970.csv"
...
# subset
mkp <- select(mkp, hhid, sfdistrict, start, end, deviceid, simserial, contains("sfnumber"), contains("enum"), contains("Q2l"), contains("Q2n1"), contains("Q2n2"), starts_with("Q2g"), Q4b1, Q4b2, Q5a, Q2_estimate, contains("Q2x"), Q5m2, Q5m3, Q5m4, Q5m5, Q5m6, Q5m7, Q5m8, Q5m9, Q5m10, Q5m1, Q10m6)
