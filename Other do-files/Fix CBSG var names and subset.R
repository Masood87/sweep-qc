library(tidyverse) 
filename <- "SWEEP_CBSG_Final_2018_10_16_06_38_22_560655.csv" 
...
cbsg <- select(cbsg, start:Q2b_1, starts_with("Q2b"), contains("Q2l"), contains("Q2n1"), contains("Q2n2"), starts_with("Q2g"), starts_with("Q3a"), starts_with("Q3c"), starts_with("Q3f"), Q4b1, Q4b2, Q4c, Q5a, contains("Q6g1"), Q7g1, Q7f1, Q7f2, Q2_estimate, starts_with("Q2x"), starts_with("Q5m"), Q6a, Q6b, Q6c, Q6d, Q6e, Q6f, Q7k1, Q7n, Q10cbsg89, Q10m6, Start_time, end_time, "_submission_time") %>% rename(start_time = Start_time, submission_time = "_submission_time") 
